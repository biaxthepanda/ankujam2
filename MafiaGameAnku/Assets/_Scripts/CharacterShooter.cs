...
public class CharacterShooter : MonoBehaviour
{
    ...
    void MovePlayer()
    {
        float horizontal = Input.GetAxisRaw("Horizontal"); // A-D / Sol-Sa�
        float vertical = Input.GetAxisRaw("Vertical");     // W-S / �leri-Geri
    ...
    void HandleShooting()
    {
        ...
        if (Input.GetMouseButtonDown(0)) // Sol t�k
        {
            ...
            //    }
            //    Debug.DrawLine(gunTransform.position, hit.point, Color.red, 1f); // K�rm�z� �izgi: isabet
            //}
            //else
            //{
            //    // �sabet yoksa ileriye sabit uzunlukta �iz
            //    Vector3 endPoint = gunTransform.position + gunTransform.forward * 200;
            //    Debug.DrawLine(gunTransform.position, endPoint, Color.yellow, 1f); // Sar� �izgi: �skalama
            //}
